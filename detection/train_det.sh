...
python train_net.py --config-file ./configs/pascal_voc_R_50_C4_24k_base.yaml \
                    ...
                    MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/r50_pixpro_400ep.pkl \
                    OUTPUT_DIR ./exp_voc/pixpro_400ep_trial_$num
done
...
# python train_net.py --config-file ./configs/coco_R_50_FPN_2x_base.yaml \
#                                 --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                                 MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/r50_moco_v1_200ep.pkl \
#                                 OUTPUT_DIR ./exp_coco2x/moco_v1_200ep
                                
# python train_net.py --config-file ./configs/coco_R_50_FPN_2x_base.yaml \
#                                 --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                                 MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/r50_moco_v2_200ep.pkl \
#                                 OUTPUT_DIR ./exp_coco2x/moco_v2_200ep

# python train_net.py --config-file ./configs/coco_R_50_FPN_2x_base.yaml \
#                                 --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                                 MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/r50_densecl_200ep.pkl \
#                                 OUTPUT_DIR ./exp_coco2x/densecl_200ep

# python train_net.py --config-file ./configs/coco_R_50_FPN_2x_base.yaml \
#                                 --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                                 MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/r50_pixpro_100ep.pkl \
#                                 OUTPUT_DIR ./exp_coco2x/pixpro_100ep

# python train_net.py --config-file ./configs/coco_R_50_FPN_2x_base.yaml \
#                                 --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                                 MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/R-50_t.pkl \
#                                 OUTPUT_DIR ./exp_coco2x/supervised

# python train_net.py --config-file ./configs/coco_R_50_FPN_1x_base.yaml \
#                                 --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                                 --resume \
#                                 MODEL.WEIGHTS ./exp_coco1x/pixpro_400ep/model_0019999.pth \
#                                 OUTPUT_DIR ./exp_coco1x/pixpro_400ep
# for num in {1..5}
# do
# python train_net.py --config-file ./configs/pascal_voc_R_50_C4_24k_base.yaml \
#                     --num-gpus 8 --dist-url tcp://127.0.0.1:1681 \
#                     MODEL.WEIGHTS /home/wangzhaoqing/.jupyter/detectron2/pretrain/r50_pixpro_100ep.pkl \
#                     OUTPUT_DIR ./exp_voc/pixpro_100ep_trial_$num
# done
